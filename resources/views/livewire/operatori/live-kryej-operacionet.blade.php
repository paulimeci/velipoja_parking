<div>
    @section('page-title', 'Kryej Operacionet')
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h4 class="fs-18 mb-0">Regjistro Hyrjen / Operacionin</h4>
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-4">
                                            <label class="label text-secondary fw-medium mb-2">Targa e Makinës <span class="text-danger">*</span></label>
                                            <input type="text" wire:model="targa"
                                                   class="form-control h-60 rounded-3 @error('targa') is-invalid @enderror"
                                                   placeholder="Shkruaj targën (p.sh. AB123CD)">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-4">
                                            <label class="label text-secondary fw-medium mb-2">Zgjidh Shërbimin <span class="text-danger">*</span></label>
                                            <div class="form-group position-relative">
                                                <select wire:model="id_kategoria" class="form-select form-control h-60 rounded-3 @error('id_kategoria') is-invalid @enderror">
                                                    <option value="" class="text-dark">-- Zgjidh Shërbimin --</option>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-4">
                                            <label class="label text-secondary fw-medium mb-2">Monedha e Pagesës <span class="text-danger">*</span></label>
                                            <div class="form-group position-relative">
                                                <select wire:model="id_monedha" class="form-select form-control h-60 rounded-3 @error('id_monedha') is-invalid @enderror">
                                                    <option value="" class="text-dark">-- Zgjidh Monedhën --</option>
                                    ...
                                    <div class="col-12 text-end">
                                        <button type="submit" class="btn btn-primary py-3 px-5 fs-14 fw-semibold rounded-3 shadow-sm">
                                            ...
                                            <i class="ri-save-line me-1"></i> Regjistro Operacionin
                                        </button>
                                    </div>
