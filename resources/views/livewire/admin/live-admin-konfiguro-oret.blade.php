<div>
    @section('page-title', 'Konfigurimi i Orëve & Çmimeve')
    ...
    @section('breadcrumb')
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center mb-0 lh-1">
                ...
                <li class="breadcrumb-item active"><span class="fw-medium">Konfigurimi i Orëve</span></li>
            </ol>
        </nav>
    @endsection
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <p class="text-secondary fs-13 mb-0">Zgjidhni një kategori për të filtruar fashat e orëve...</p>
        </div>
        <button type="button" wire:click="hapModalin" class="btn btn-primary rounded-3">
            <i class="ri-add-line me-1"></i> Shto Konfigurim Orësh
        </button>
    </div>
                ...
                <div class="card border border-{{ $color }} border-opacity-25 rounded-3 mb-3 bg-{{ $color }} bg-opacity-10
                    ...
                    <div class="card-body p-2 px-3">
                        <div class="d-flex justify-content-end gap-1 mb-1">
                            @if($aktive)
                                <button wire:click.stop="filtroKat(null)" class="border-0 bg-transparent p-0 lh-1" title="Hiq filtrin">
                        ...
                        <span class="fs-11 text-secondary fw-medium">Kliko për filtrim</span>
                    </div>
                </div>
            </div>
        @empty
        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                <div class="d-flex align-items-center gap-3">
                    <h5 class="mb-0 fw-semibold">Orët & Çmimet</h5>
                    @if($filterKatId)
                ...
                <form class="position-relative table-src-form me-0" onsubmit="event.preventDefault();">
                    <input wire:model.live.debounce.300ms="search" type="text" class="form-control" placeholder="Kërko fashë orësh...">
                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        <tr>
                            ...
                            <th scope="col">Çmime të tjera</th>
                            ...
                            <tr wire:key="konfig-{{ $konfig->id }}">
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-end gap-2 pe-3">
                                        <button type="button" wire:click="shikoOret({{ $konfig->id }})" class="p-0 border-0 bg-transparent lh-1" title="Shiko">
                                            <i class="material-symbols-outlined fs-18 text-primary">visibility</i>
                                        </button>
                                        <button type="button" wire:click="editOret({{ $konfig->id }})" class="p-0 border-0 bg-transparent lh-1" title="Edito">
                                        ...
                                        <button type="button" wire:click="fshiOret({{ $konfig->id }})"
                                                ...
                                                class="p-0 border-0 bg-transparent lh-1" title="Fshi">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted py-5 fs-14">
                                    ...
                                    Nuk ka asnjë konfigurim të regjistruar për këtë kategori.
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 rounded-3 shadow">
                    ...
                    <div class="modal-body pt-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-medium">Kategoria e Rezervimit <span class="text-danger">*</span></label>
