<form action="{{ Route('store_pozicions') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="modal-body text-center">
        ...
        <div class="form-group mb-3">
            <label for="kategoria">POSIZIONE</label>
            <input type="text" name="pozicioni" class="form-control" value="{{ old('pozicioni') }}" placeholder="Inserisci un nome per la posizione.">
            @error('pozicioni')
