            ...
            <div class="mb-3">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <p class="text-center text-secondary f-w-500">403 Forbidden response status code indicates that
                            the server
                            understands the request<br> but refuses to authorize it.</p>
                    </div>
                </div>
            </div>
            <a role="button" href="{{route('index')}}" class="btn btn-lg btn-success"><i class="ti ti-home"></i> Back To
                Home</a>
        </div>
    </div>
</div>
